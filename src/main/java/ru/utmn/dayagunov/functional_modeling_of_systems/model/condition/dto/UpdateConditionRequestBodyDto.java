...
public class UpdateConditionRequestBodyDto {
    ...
    @Schema(requiredMode = NOT_REQUIRED, description = "Ожидаемое значение. Может принимать в качестве значения списки строк. \n" +
            "Например, 1,2,3. В таком случае проверка будет по каждому значению", example = "1")
    @Size(max = 500)
